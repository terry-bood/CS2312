public class Day {
	...
	public Day next() 
	{
		if (isEndOfAMonth())
			if (month==12)
				...
				return new Day(this.year,this.month+1,1); // <== your task: first day of next month
		else
	...
	public Day prev()
	{
		...
		while(!valid(this.year,this.month-1,prevday))
		{
			prevday--;
		}
		
		return new Day(year,month-1,prevday);		
	}	
