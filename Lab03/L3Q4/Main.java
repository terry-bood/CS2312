...
public class Main{
	...
	{	
		...
		System.out.print("Enter the numberof teams: ");
		...
		*/
		...
		System.out.print("\nEnter " + numOfTeams +" task names (e.g. \"Lab05 Lab06 Lab07 ..\"): ");
	...
	private static Team[] createTeams(Student[] students, int numOfTeams) 
	{
		...
		*/
		...
		int left =0;
		int right = students.length/numOfTeams;
		int index = right;
		for(int i=0;i<numOfTeams;i++){
			char teamLetter = (char)('A' + i);
			String teamS = "Team " + teamLetter;
			result[i] = new Team(teamS, Arrays.copyOfRange(students, left,right));
			left = right;
			right += index;
		}
